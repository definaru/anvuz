    ...
    <div class="container py-5">
        ...
        <div class="row text-body-tertiary">
            ...
            <div class="col-12 d-flex flex-md-row flex-column align-items-center justify-content-center gap-md-3 gap-1 py-4">
                <a href="/document/privacy" class="text-white-50 link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Конфиденциальность и политика</a>
                <a href="/document/user_agreement" class="text-white-50 link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Пользовательское соглашение</a>
