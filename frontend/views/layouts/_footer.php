...
?>
<footer class="footer mt-auto py-5 text-muted bg-primary">
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-12 <?=$key == 0 ? 'col-md-6' : 'col-md-2';?>">
                ...
                <ul class="d-grid gap-2">
                    ...
                    <li>
                        <?=$tag !== 'a' ? Html::tag('span', $links['icon'], ['class' => 'text-white-50 pe-1']) : '';?>
                        <?=$tag === 'tel' ?
                            Html::tel(PhoneNumberFormatter::standert($links["text"]), $links["link"], ['class' => $className]) : 
        ...
        <div class="row text-body-tertiary">
            ...
            <div class="col-12 d-flex align-items-center justify-content-center gap-3 py-4">
                <a href="/document/privacy-policy" class="text-white-50 link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Конфиденциальность и политика</a>
                <a href="/document/user-agreement" class="text-white-50 link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Пользовательское соглашение</a>
                <a href="/sitemap.xml" class="text-white-50 link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Карта сайта</a>
            </div>
