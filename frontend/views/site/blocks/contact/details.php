            ...
            <div class="col-12 col-md-5">
                <div>
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item ps-0"><strong>Юрид. адрес:</strong> <br />105005, <?= env('ADDRESS');?></li>
                        <li class="list-group-item ps-0"><strong>Факт. адрес:</strong> <br />105005, <?= env('ADDRESS');?></li>
                    </ul>
