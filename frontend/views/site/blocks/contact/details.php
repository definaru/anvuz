            ...
            <div class="col-12 col-md-4">
                <div>
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item ps-0"><strong>Юрид. адрес:</strong> <br />105005, г. Москва, ул. Радио, д. 22, офис 225</li>
                        <li class="list-group-item ps-0"><strong>Факт. адрес:</strong> <br />105005, г. Москва, ул. Радио, д. 22, офис 225</li>
                    </ul>

                    <ul class="list-group list-group-flush mt-5">
                        <li class="list-group-item ps-0"><i>ОАО «Газпромбанк»</i></li>
